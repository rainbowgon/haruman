  ...
  return (
    <>
      <div className="context_box">
        ...
        <h2 className="Agreement_middle_title">4. 개인정보의 제공 및 공유</h2>
        <p className="Agreement_text">
          회사는 이용자의 개인정보를 제3자에게 제공하지 않습니다. 다만, 법령에
          따라 제출 의무가 발생한 경우에는 예외로 합니다.
        </p>
        <br />

        <h2 className="Agreement_middle_title">5. 개인정보의 보유 및 파기</h2>
        <p className="Agreement_text">
          개인정보 보유기간은 [보유기간 설정, 예: 서비스 탈퇴 후 1년]로 정하며,
          보유기간이 경과한 개인정보는 지체 없이 파기됩니다.
        </p>
        <br />
        ...
        <h2 className="Agreement_middle_title">7. 개인정보 보호책임자</h2>
        <ul>
        ...
        <h2 className="Agreement_middle_title">8. 개인정보 취급 방침의 변경</h2>
        <p className="Agreement_text">
          본 개인정보 취급 방침은 법령 및 정부 지침 변경, 회사의 정책 변경 등에
          따라 내용이 변경될 수 있습니다. 변경 시 본 페이지를 통해 사전
          고지합니다.
        </p>
        <br />
