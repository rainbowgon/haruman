package ssafy.haruman.global.response.oauth.google.client;

import org.springframework.stereotype.Component;
import org.springframework.util.MultiValueMap;
import org.springframework.web.reactive.function.client.WebClient;
import ssafy.haruman.global.error.exception.GoogleAccessTokenFailureException;
import ssafy.haruman.global.error.exception.GoogleUserInfoFailureException;
import ssafy.haruman.global.response.oauth.google.dto.GoogleMemberResponse;
import ssafy.haruman.global.response.oauth.google.dto.GoogleToken;
...
public class GoogleApiClient {
    ...
    public GoogleToken fetchToken(MultiValueMap<String, String> params) {
        ...
        if (googleToken == null) {
            throw GoogleAccessTokenFailureException.EXCEPTION;
        }
    ...
    public GoogleMemberResponse fetchMember(String bearerToken) {
        ...
        if (googleMemberResponse == null) {
            throw GoogleUserInfoFailureException.EXCEPTION;
        }
